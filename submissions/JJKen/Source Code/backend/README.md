...
- `AGORA_CONVO_AI_START_PATH` (default `/api/conversational-ai/v1/projects/{appId}/join`)
- `AGORA_CONVO_AI_STOP_PATH` (default `/api/conversational-ai/v1/projects/{appId}/leave`)
